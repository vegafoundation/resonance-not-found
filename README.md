...
This repository contains the conceptual definition and theoretical framework for **Not Found**, 
...
├── LICENSE             # CC BY 4.0
├── paper/
│   └── not-found.tex    # LaTeX dissertation
├── whitepaper/
│   └── not-found.md     # White paper
└── translations/
    ├── de/             # German
    ├── en/             # English
    ├── tr/             # Turkish
...
```bibtex
@misc{vega2025notfound,
  author = {Vega, Adam Eren},
  title = {Not Found: A Conceptual Framework},
  year = {2025},
  publisher = {GitHub},
  url = {https://github.com/vegafoundation/not-found}
}
```
